        ...
        <div className="flex items-center flex-col">
          ...
          <form onSubmit={formik.handleSubmit}>
            ...
            {formik.touched.password && formik.errors.password && (
              <div className="text-red-500 flex justify-start items-start text-xs sm:text-base mt-2 pl-14">
            ...
            <div className="flex justify-center pt-12 pb-2">
              <button
                ...
                className="bg-blue-700 rounded-xl sm:text-lg text-base font-semibold text-white w-full h-12"
              >
                Continue
              </button>
            </div>
