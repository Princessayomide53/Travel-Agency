...
function Hero() {
  ...
  return (
    ...
    controls autoPlay onEnded={stopPlaying}/></div>) : ( <div className="flex gap-4 absolute top-[390px] md:top-[-98px] md:left-[290px] lg:top-[15px] lg:left-[380px] left-[55%] transform -translate-x-1/2 -translate-y-1/2 mac:top-[5px]"><button className="px-3 backdrop:bg-[#DF6951] shadow-lg shadow-[#DF6951] mt-5 rounded-full h-10 bg-[#DF6951]" onClick={handleClick}>
