...
<div className='absolute top-24 xl:right-44 lg:right-16 right-5 md:right-16 pro:right-32 mac:right-64 overflow-hidden'><img src={send1} alt="" className='w-10 h-10 sm:w-16 sm:h-16'/></div>
